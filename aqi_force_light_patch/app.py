...
st.markdown(
    ...
    <style>
      /*
         Force one predictable LIGHT palette regardless of Streamlit/browser dark mode.
         This deliberately prioritizes readability over theme inheritance.
      */
      :root {
      ...
      /* Force normal Streamlit copy to dark text. */
      ...
      /* Inputs/selects/buttons remain readable even if OS/browser prefers dark. */
      ...
      .stButton button * { color: #111827 !important; }
      ...
      /* Code snippets are also forced light so black text never lands on a dark code box. */
      ...
      .hero h1 { margin: 0; color: #111827 !important; font-size: 2.25rem; }
      .hero p { margin: .5rem 0 0 0; color: #374151 !important; font-size: 1.02rem; }
      ...
      .model-banner * { color: #111827 !important; }
      ...
      .method-note * { color: #111827 !important; }
      ...
      .card-label { color: #374151 !important; font-size: .83rem; font-weight: 700; letter-spacing: .02em; }
      .card-value { color: #111827 !important; font-size: 2rem; font-weight: 780; margin-top: .18rem; }
      .card-sub { color: #374151 !important; font-size: .88rem; margin-top: .3rem; }
      ...
      .shap-note * { color: #111827 !important; }
      ...
      /* Links stay visible and distinct. */
      a { color: #245b9e !important; }
    </style>
    """,
